...
public class CoreGlueSearchModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        install(FactoryModules.newFactory(SearchFactory.class, CoreSearch.class));
        ...
        install(FactoryModules.newFactory(RemoteFileDescAdapter.Factory.class, RemoteFileDescAdapter.class));
        install(FactoryModules.newFactory(TorrentWebSearchFactory.class, TorrentWebSearch.class));
        install(FactoryModules.newFactory(TorrentUriPrioritizerFactory.class, TorrentUriPrioritizerImpl.class));
