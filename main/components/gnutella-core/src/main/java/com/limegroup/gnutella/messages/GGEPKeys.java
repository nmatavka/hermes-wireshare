...
public class GGEPKeys {
    ...
    /** The extension header (key) for IpPort request. */
    ...
    /** The extension header (key) indicating the size of the file is 64 bit. */
    public static final String GGEP_HEADER_LARGE_FILE = "LF";
    /** The prefix of the extension header (key) indicating support for partial results. */
