...
public class ChatSettings extends LimeProps {
    ...
    private static String paragraph1 = "<p>" + I18n.tr("We at WireShare are actively looking into remedies.  In the meantime, you will still be able to browse friends.") + "</p>";
