...
/** Initializes (creates, starts, & displays) the WireShare Core & UI. */
final class Initializer {
     ...
     * 
     * If this throws any exceptions, then WireShare was not able to construct
    ...
    private void setupCallbacksAndListeners() {
        ...
        try {
            ...
            //catching so as not to prevent WireShare startup, LWC-5005
    ...
    private void validateStartup(String[] args) {        
        ...
        // Exit if another WireShare is already running...
    ...
    private void runExternalChecks(String[] args, Injector injector) {        
        ...
        // Test for preexisting WireShare and pass it a magnet URL if one
        // has been passed in.
    ...
    /**
     * Warns the user that another instance of WireShare appears to be
    ...
    private boolean warnAlreadyRunning() {
        ...
        final String message = I18n.tr("Another instance of WireShare " +
                "appears to be running. Please completely shut down all " +
                "other instances of WireShare before continuing. If this " +
        ...
        SwingUtils.invokeNowOrWait(new Runnable() {
            ...
            public void run() {
                response.set(JOptionPane.showConfirmDialog(null,
                        ...
                        I18n.tr("WireShare is already running"),
