...
public final class FatalBugManager {
    ...
    public static void reviewBug(final LocalClientInfo info) {
        ...
        dialog.setTitle("WireShare Couldn't Start :-(");
        ...
        String msg = "Sorry, WireShare ran into a problem while it was starting up. This is usually caused by a problem during installation.";
        ...
        final String defaultDesc = "Want to help? Write in some extra info to help us find what's causing WireShare to crash.";
