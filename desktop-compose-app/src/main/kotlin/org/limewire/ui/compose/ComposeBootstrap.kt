...
import org.limewire.ui.compose.integration.CoreComposeFriendAccountConfigurationManager
...
import org.limewire.ui.compose.integration.SwingComposeFileAppearanceService
...
import org.limewire.ui.compose.integration.SwingComposeSettingsService
...
import org.limewire.ui.swing.util.BasicFileIconController
...
object ComposeBootstrap {
    ...
    private fun createController(
        ...
        val injector = Guice.createInjector(
            ...
            LimeWireCoreModule(),
            CoreGlueModule(),
            LimeWireMojitoVisualModule(),
            object : AbstractModule() {
                override fun configure() {
                    bind(NonBlockFileIconController::class.java).to(BasicFileIconController::class.java)
                }
            }
        )
        ...
        val friendAccountConfigurationManager = CoreComposeFriendAccountConfigurationManager(
            injector.getInstance(PasswordManager::class.java),
            injector.getInstance(XMPPResourceFactory::class.java)
        )
        val composeSettingsService = SwingComposeSettingsService(
        ...
        val friendService = SwingComposeFriendService(
            injector.getInstance(org.limewire.friend.api.FriendConnectionFactory::class.java),
            friendAccountConfigurationManager,
            composeFriendsInjector.getInstance(ComposeChatBridge::class.java),
            injector.getInstance(Key.get(object : TypeLiteral<ListenerSupport<FriendRequestEvent>>() {}))
        )
        val advancedToolsService = CoreComposeAdvancedToolsService(
            ...
            mojitoArcsPlugin = injector.findOptionalInstance(
                Key.get(SwingUiPlugin::class.java, Names.named("MojitoArcsPlugin"))
            )
        )
        val fileAppearanceService = SwingComposeFileAppearanceService(
            categoryManager = injector.getInstance(CategoryManager::class.java),
            iconManager = injector.getInstance(org.limewire.ui.swing.util.IconManager::class.java),
            categoryIconManager = injector.getInstance(org.limewire.ui.swing.util.CategoryIconManager::class.java),
            propertiableHeadings = createPropertiableHeadings(injector)
        )
    ...
    private fun validateStartupArguments(args: Array<String>) {
    ...
    private fun ensureStartupSettingsConfigured() {
    ...
    private fun createPropertiableHeadings(injector: Injector): PropertiableHeadings {
        val implementation = Class.forName("org.limewire.ui.swing.util.PropertiableHeadingsImpl")
        val constructor = implementation.getDeclaredConstructor(com.google.inject.Provider::class.java)
        constructor.isAccessible = true
        return constructor.newInstance(injector.getProvider(IconManager::class.java)) as PropertiableHeadings
    }
