...
+ (BOOL) sendNotification:(NSString *)notificationTitle
    ...
    notificationTimeDelayShow:(NSTimeInterval)notificationTimeDelayShow
{
    ...
    notification.deliveryDate = [[NSDate date] dateByAddingTimeInterval:notificationTimeDelayShow];
