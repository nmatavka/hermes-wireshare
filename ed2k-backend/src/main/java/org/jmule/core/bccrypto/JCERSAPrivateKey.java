    ...
    implements RSAPrivateKey, PKCS12BagAttributeCarrier
{
    ...
    {
        PrivateKeyInfo info = new PrivateKeyInfo(new AlgorithmIdentifier(Identifiers.rsaEncryption, new DERNull()), new RSAPrivateKeyStructure(getModulus(), ZERO, getPrivateExponent(), ZERO, ZERO, ZERO, ZERO, ZERO).getDERObject());
