    ...
    implements RSAPublicKey
{
    ...
    public byte[] getEncoded()
    {
        ...
        SubjectPublicKeyInfo    info = new SubjectPublicKeyInfo(new AlgorithmIdentifier(Identifiers.rsaEncryption, new DERNull()), new RSAPublicKeyStructure(getModulus(), getPublicExponent()).getDERObject());
