...
public class SettingsWarningManager {
        ...
        if (LimeWireUtils.isTemporaryDirectoryInUse()) {
            MessageService
                    .showMessage(I18nMarker
                            .marktr("WireShare was unable to create your settings folder and is using a temporary folder.  Your settings may be deleted when you close WireShare. "));
        }
    }
    ...
    public static void checkSettingsLoadSaveFailure() {
        if (LimeWireUtils.hasSettingsLoadSaveFailures()) {
            ...
            MessageService
                    .showMessage(I18nMarker
                            .marktr("WireShare has encountered problems in managing your settings.  Your settings changes may not be saved on shutdown."));
        }
    }
