...
public class HomePanel extends JXPanel {
    ...
    private static final String DEFAULT_URL = "file:///" + System.getProperty("user.dir").replace("\\","/") + "/lib/WSHome.xhtml";
    ...
    public void load(String url) {
        ...
        if(MozillaInitialization.isInitialized()) {            
    		...
    		try {
	            ...
	            String offlinePage = "<html><head><style type=\"text/css\">* {margin: 0;  padding: 0;} body {background: #EAEAEA url(\""+ bgImage.toExternalForm() + "\") repeat-x left top; font-family: Arial, sans-serif;}table#layout tr td#header {  background: url(\"" + topImage.toExternalForm() + "\") no-repeat center top;}table#layout tr td h2 {  font-size: 16px;  margin: 0 0 8px 0;  color: #807E7E;}table#layout tr td p {  font-size: 11px;  color: #931F22;}</style></head><body><center>  <table id=\"layout\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"400\" style=\"margin: 46px 0 0 0\">    <tr valign=\"top\">      <td id=\"header\" height=\"127\" align=\"center\"></td>    </tr>    <tr valign=\"top\">      <td align=\"center\">        <h2>Error! Unable to load WSHome.xhtml</h2>        <p>Please check " + System.getProperty("user.dir").replace("\\","/") + "/lib/</p>      </td>    </tr>  </table></center></body></html>";
