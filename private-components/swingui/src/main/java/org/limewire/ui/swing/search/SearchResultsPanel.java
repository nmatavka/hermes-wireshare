...
public class SearchResultsPanel extends JXPanel implements Disposable {
     ...
     * AWAITING_CONNECTIONS indicates that an overlay with a busy icon and a "WireShare is connecting..." message should be shown.
    ...
    protected void configureEnclosingScrollPane() {
        ...
        scrollPane.setCorner(ScrollPaneConstants.UPPER_RIGHT_CORNER, cornerComponent);
    }
