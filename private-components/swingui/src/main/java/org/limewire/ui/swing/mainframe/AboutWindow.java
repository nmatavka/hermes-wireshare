...
class AboutWindow {
	...
	AboutWindow(JFrame frame, Application application) {
		...
		dialog.setTitle(I18n.tr("About WireShare"));
        ...
        //  set up WireShare version label
        JLabel client = new JLabel(I18n.tr("WireShare") +
        ...
        //  set up wireshare.net label
        HyperlinkButton url = new HyperlinkButton("http://www.gnutellaforums.com/");
        url.addActionListener(new UrlAction("http://www.gnutellaforums.com/"));
	...
	private ScrollingTextPane createScrollingPane() {
        ...
        sb.append(I18n.tr("LimeWire open source contributors have provided significant code and many bug fixes, ideas, research, etc. to the project as well. Those listed below have either written code that is distributed with every version of WireShare (previously LimeWire), have identified serious bugs in the code, or both:"));
        sb.append("<table border=\"0\" cellspacing=\"5\">" +                 
                " <tr>" +
                "   <td>Richie Bielak</td>" +
        ...
        sb.append(I18n.tr("We would also like to thank the many contributors to the internationalization project, both for the WireShare application and for the LimeWire web site, which has, unfortunately, been taken down."));
        sb.append("<p>");
