...
public class AVInfoPanel extends JPanel {
    ...
    public void showVendorMessage() {
        ...
        String message = I18n.tr("WireShare's Anti-Virus protection is powered by AVG.  AVG scans, detects and deletes files that are suspected to contain viruses or spyware.  <a href=\"{0}\">Learn more</a>", AVHOME);
    ...
    public void showThreatMessage(DownloadItem item, boolean showOption) {
        ...
        String message = I18n.tr("{0} is suspected to contain a virus or spyware and has automatically been deleted for your protection.  WireShare's Anti-Virus protection is powered by AVG.", item.getFileName());
