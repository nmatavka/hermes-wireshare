...
public class IntentDialog extends LimeJDialog {
    ...
    public IntentDialog(String version, VirusEngine virusEngine){
        ...
        final String title = "WireShare " + version; 
    ...
    private void setTextContents() {
        ...
        String bodyText1
        = I18n.tr("<html><body>WireShare is a peer-to-peer programs for sharing authorized files only. Copyright laws may forbid obtaining or distributing certain copyrighted content. Learn more information about <a href=\"{0}\">Copyright</a></body></html>.", 0);
        String copyInfringementText = I18n.tr("Copyright Infringement");
        String privacyText = I18n.tr("WireShare Privacy Policy");
        String licenseText = I18n.tr("WireShare License Agreement");
        String avgLicenseText = I18n.tr("AVG Anti-Virus License Agreement");
        String agreementText = virusEngine.isSupported() ? I18n.tr("By clicking \"I Agree\", you agree that you have read, understand and assent to the terms of the WireShare and AVG Anti-Virus License Agreements and WireShare Privacy Policy. You also agree that you will not use WireShare for copyright infringement.") : I18n.tr("By clicking \"I Agree\", you agree that you have read, understand and assent to the terms of the WireShare License Agreement and WireShare Privacy Policy. You also agree that you will not use WireShare for copyright infringement.");
