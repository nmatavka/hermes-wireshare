...
/**
 * This panel is shown if WireShare has not fully connected to its peers AND has not
 * received any results for the user's query.
 * It shows a "WireShare is connecting..." message with a busy icon.
 *
 */
class AwaitingConnectionsPanel extends JPanel
{
    ...
    private JPanel createBusyIconPanel() {
        ...
        JLabel connectingLabel = new JLabel(I18n.tr("WireShare is connecting..."));
